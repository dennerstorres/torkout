...
$expectedContracts = '5f350047004bf754939ab5ae50c862183d07a0665d1caf68b8a858ef2fd56c48'
...
Write-Host 'Schema and public contracts match the 2.1.0 freeze.' -ForegroundColor Green
